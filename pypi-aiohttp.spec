...
Source0  : https://files.pythonhosted.org/packages/54/07/9467d3f8dae29b14f423b414d9e67512a76743c5bb7686fb05fe10c9cc3e/aiohttp-3.9.1.tar.gz
...
%prep
%setup -q -n aiohttp-3.9.1
cd %{_builddir}/aiohttp-3.9.1
pushd ..
cp -a aiohttp-3.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704911271
