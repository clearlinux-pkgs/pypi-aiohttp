...
Source0  : https://files.pythonhosted.org/packages/04/a4/e3679773ea7eb5b37a2c998e25b017cc5349edf6ba2739d1f32855cfb11b/aiohttp-3.9.5.tar.gz
...
%prep
%setup -q -n aiohttp-3.9.5
cd %{_builddir}/aiohttp-3.9.5
pushd ..
cp -a aiohttp-3.9.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713365794
