...
Source0  : https://files.pythonhosted.org/packages/63/e7/fa1a8c00e2c54b05dc8cb5d1439f627f7c267874e3f7bb047146116020f9/aiohttp-3.11.18.tar.gz
...
%prep
%setup -q -n aiohttp-3.11.18
cd %{_builddir}/aiohttp-3.11.18
pushd ..
cp -a aiohttp-3.11.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745243635
