...
Source0  : https://files.pythonhosted.org/packages/7e/0b/4235b25496c741f4c9f75a94951fbc15c48537349a03448687fb226256ef/aiohttp-3.9.4.tar.gz
...
%prep
%setup -q -n aiohttp-3.9.4
cd %{_builddir}/aiohttp-3.9.4
pushd ..
cp -a aiohttp-3.9.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712935703
